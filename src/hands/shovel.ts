 ...
 * Общий риг замахов и отдачи — из ядра; здесь только модель и кейфреймы.
 *
...
const STROKES: Record<ShovelStroke, Stroke> = {
  ...
  dig: {
    ...
    pz: pz([[0, 0], [0.38, 0.12, 'io'], [0.46, -0.26, 'in'], [0.535, -0.26, 'hold'], [0.7, -0.1, 'out'], [1, 0, 'out']]),
  ...
  build: {
    ...
    pz: pz([[0, 0], [0.4, 0.06, 'io'], [0.48, -0.18, 'in'], [0.545, -0.18, 'hold'], [0.72, -0.05, 'out'], [1, 0, 'out']]),
