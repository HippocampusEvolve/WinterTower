 ...
 *
 * Чего этот инструмент НЕ заменяет: гамму — для неё нужен рендер, то есть
 * браузер. Коллизии и наложения тоже не его дело, но браузера они больше не
 * требуют: их считает внешняя проверка геометрии, по треугольникам.
 */
